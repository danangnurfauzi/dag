						  ...
						  <table class="table table-bordered table-striped">
							...
							<tbody class="text-center">
							  ...
							  <tr>
							  	...
							  	<td>
							  		<a href="<?php echo site_url('member/emailAction/sendActivation/'.$row->MemberID) ?>">Kirim Email Aktivasi</a> | 
							  		<a href="<?php echo site_url('member/emailAction/sendLogLasActivity/'.$row->MemberID) ?>" class="confirmation">Kirim Email Log Last Activity</a>
							  	</td>
							  </tr>
							  <?php } ?>
							</tbody>
